...
"[project]/src/app/campaigns/[id]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$scenario$2f5b$id$5d2f$Scenario$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__ = __turbopack_context__.i("[project]/src/app/scenario/[id]/Scenario.module.css [app-client] (css module)"); // Reusing scenario styles
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function CampaignDetailPage({ params }) {
    ...
    const campaign = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CAMPAIGNS"].find((c)=>c.id === id);
    ...
    if (!campaign) (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["notFound"])();
    const handleExecute = async ()=>{
        ...
        for(let i = 0; i < campaign.steps.length; i++){
            ...
            const scenario = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SCENARIOS"].find((s)=>s.id === stepId);
            if (!scenario) {
                setLogs((p)=>[
                        ...p,
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: campaign.steps.map((stepId, index)=>{
                            const s = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SCENARIOS"].find((x)=>x.id === stepId);
...
_s(CampaignDetailPage, "YgxorX3lAWaPW9bPShjk40Y2htQ=");
...
//# sourceMappingURL=src_d8993f97._.js.map